...
public class PortalLoginView {
    ...
    public Parent getView() {
        ...
        VBox customerCard = createPortalCard("\uD83D\uDED2", "Customer", "Browse events and buy tickets");
        customerCard.setOnMouseClicked(e -> mainView.showCustomerDashboard());

        cardsBox.getChildren().addAll(adminCard, coordinatorCard, customerCard);
